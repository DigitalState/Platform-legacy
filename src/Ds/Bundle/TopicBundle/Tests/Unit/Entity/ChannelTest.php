...
class ChannelTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testAccessors()
    {
        ...
        $titles = new ArrayCollection;
        $this->assertInstanceOf('Ds\Bundle\TopicBundle\Entity\Channel', $entity->setCreatedAt($createdAt), 'A fluent interface');
        $this->assertEquals($createdAt, $entity->getCreatedAt(), 'Set value matches get value.');
        $this->assertInstanceOf('Ds\Bundle\TopicBundle\Entity\Channel', $entity->setUpdatedAt($updatedAt), 'A fluent interface');
        $this->assertEquals($updatedAt, $entity->getUpdatedAt(), 'Set value matches get value.');
        $this->assertInstanceOf('Ds\Bundle\TopicBundle\Entity\Channel', $entity->setTitles($titles), 'A fluent interface');
