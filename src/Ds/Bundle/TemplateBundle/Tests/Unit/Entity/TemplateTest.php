...
namespace Ds\Bundle\TemplateBundle\Tests\Unit\Entity;

use PHPUnit_Framework_TestCase;
use Ds\Bundle\TemplateBundle\Entity\Template;
use DateTime;
...
class TemplateTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testAccessors()
    {
        ...
        $this->assertInstanceOf('Ds\Bundle\TemplateBundle\Entity\Template', $entity->setCreatedAt($createdAt), 'A fluent interface');
        $this->assertEquals($createdAt, $entity->getCreatedAt(), 'Set value matches get value.');
        $this->assertInstanceOf('Ds\Bundle\TemplateBundle\Entity\Template', $entity->setUpdatedAt($updatedAt), 'A fluent interface');
